...
public class QuestTaskController {
    ...
    private ResponseEntity<String> createQuestTasks(Principal principal,
                                                    ...
                                                    @RequestPart String questTaskModel,
    ...
    @GetMapping("/get-tasks-by-quest-id/{id}")
    public ResponseEntity<List<QuestTaskModel>> queryQuests(@PathVariable UUID id) {


        return ResponseEntity.ok(taskRepository.findAllByParentQuestId(id));
    }
}
